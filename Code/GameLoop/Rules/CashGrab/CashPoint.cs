...
public partial class CashPoint : Component, ICustomMinimapIcon, IMarkerObject
{
	...
	/// </summary>
	[Property, Sync( SyncFlags.FromHost ), Change( nameof( StateChanged ) )] public CashPointState State { get; set; } = CashPointState.Inactive;
	...
	public void Activate()
	{
		...
		// Add the cash bag component BEFORE spawning it over the network.
